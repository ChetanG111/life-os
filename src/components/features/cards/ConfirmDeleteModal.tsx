                    ...
                    <div className="p-8 flex flex-col items-center text-center">
                        ...
                        <div className="flex flex-col w-full gap-3">
                            <button
                                ...
                                className="h-14 w-full bg-red-500 text-white rounded-2xl font-bold text-lg active:scale-95 "
                            >
                                Delete
                            </button>
                            <button
                                ...
                                className="h-14 w-full bg-white/5 text-white rounded-2xl font-medium text-lg active:scale-95 "
                            >
                                Cancel
                            </button>
                        </div>
